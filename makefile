...
Mesh3D : mesh.cpp getCenters.cpp headers/cells.h headers/points.h headers/faces.h dataReaders/cell_reader.cpp dataReaders/point_reader.cpp dataReaders/face_reader.cpp 
	g++ mesh.cpp getCenters.cpp headers/cells.h headers/points.h headers/faces.h dataReaders/cell_reader.cpp dataReaders/point_reader.cpp dataReaders/face_reader.cpp -o Mesh3D.o
